...
<div class="ticker">
  <div class="ticker-track">
    <span class="ticker-text">
      เรียนไรเดอร์ทุกท่าน! ขณะนี้เรากำลังเตรียมออเดอร์ของท่านอยู่ โดยสามารถดูเวลาการเตรียมอาหารได้ที่หน้าจอ เมื่อออเดอร์พร้อมแล้ว พนักงานของเราจะนำออเดอร์ไปส่งให้ท่านทันที ขอขอบคุณที่ช่วยให้การจัดส่งเป็นไปอย่างรวดเร็วและมีคุณภาพ!
    </span>
    <span class="ticker-text">
      เรียนไรเดอร์ทุกท่าน! ขณะนี้เรากำลังเตรียมออเดอร์ของท่านอยู่ โดยสามารถดูเวลาการเตรียมอาหารได้ที่หน้าจอ เมื่อออเดอร์พร้อมแล้ว พนักงานของเราจะนำออเดอร์ไปส่งให้ท่านทันที ขอขอบคุณที่ช่วยให้การจัดส่งเป็นไปอย่างรวดเร็วและมีคุณภาพ!
    </span>
...
function getStartTs(orderNo){
  const key="courier_start_"+orderNo;
...
function remainingSec(o,nowMs){
  const startTs=getStartTs(o.order);
  const minutes=Number(o.time || o.minutes || 25);
  const endMs=startTs + minutes * 60000;
    ...
    return `
      <div class="row ${isReady ? "ready" : ""}">
        <div>
          ...
          <div class="sub">${o.time || o.minutes || 25} min</div>
        </div>
